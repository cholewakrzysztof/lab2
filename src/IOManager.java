...
public class IOManager {
    ...
    public IOManager(Integer maxOwnAttributes, Integer maxSearchAttributes,Integer numberOfGuests){
        this.maxOwnAttributes = maxOwnAttributes;
        this.maxSearchAttributes = maxSearchAttributes;
    ...
    public static String[] getGuestStringArray(List<Guest> guests){
        ...
        for (int i=0; i<guests.size();i++){
            result[i] = guests.get(i).printAssignedGuests();
        }
        return result;
    }
